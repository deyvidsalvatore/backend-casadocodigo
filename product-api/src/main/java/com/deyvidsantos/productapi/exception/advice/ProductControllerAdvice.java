package com.deyvidsantos.productapi.exception.advice;

import java.util.Date;
import java.util.List;

import com.deyvidsantos.shoppingclient.dto.ErrorDTO;
...
@ControllerAdvice(basePackages = "com.deyvidsantos.productapi.controllers")
